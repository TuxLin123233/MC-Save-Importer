...
```mermaid
graph TB
A["入口脚本<br/>src/main.py"] --> B["GUI 应用<br/>src/gui.py"]
...
**章节来源**
- [src/gui.py:128-138](file://src/gui.py#L128-L138)
...
- [src/gui.py:154-165](file://src/gui.py#L154-L165)
...
**图表来源**
- [requirements.txt:1-10](file://requirements.txt#L1-L10)
- [src/gui.py:1-3](file://src/gui.py#L1-L3)
...
**章节来源**
- [src/gui.py:234-240](file://src/gui.py#L234-L240)
- [src/gui.py:255-261](file://src/gui.py#L255-L261)
- [src/utils.py:26-27](file://src/utils.py#L26-L27)
- [src/gui.py:275-277](file://src/gui.py#L275-L277)
